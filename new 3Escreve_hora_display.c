...
void escreveDisplay7(int minuto, int segundo){

    PORTD = 0B00000000;
	PORTE = 0B00000001;
	PORTD = valoresDisplay7[(minuto/10)%10];
	delay_ms(pausa);
	
	PORTD = 0B00000000;
	PORTE = 0B00000010;
	PORTD = valoresDisplay7[(minuto)%10];
	delay_ms(pausa);
	
	PORTD = 0B00000000;
	PORTE = 0B00000100;
	PORTD = valoresDisplay7[(segundo/10)%10];
	delay_ms(pausa);
	
	PORTE = 0B00000000;
	PORTD = 0B00000000;
	PORTD = valoresDisplay7[segundo%10];
	PORTA.F5 = 1;
	delay_ms(pausa);
	PORTA.F5 = 0;
	PORTD = 0B00000000;
...
void main(){
	...
	*/
	...
	while(1){
		le_hora(&hora_atual, &minuto_atual, &segundo_atual);
		escreveDisplay7(minuto_atual, segundo_atual);
	}
